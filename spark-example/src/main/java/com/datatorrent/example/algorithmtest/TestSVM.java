...
/**
 * Created by krushika on 30/12/16.
 */
...
public class TestSVM{
    public static void main(String[] args){
        ...
        ApexRDD<LabeledPoint> data = new ApexRDD<>(MLUtils.loadLibSVMFile(sc,"/home/krushika/spark-apex/spark-example/src/main/resources/data/sample_libsvm_data.txt"),tag);
